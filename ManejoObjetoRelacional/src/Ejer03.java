...
public class Ejer03 {
    public static void main(java.lang.String[] args) {
        ...
        try {
            ...
            String sql = "INSERT INTO cliente VALUES (?,?,?,CAST (ARRAY[('movil_personal',(34,'664080752')),('movil_casa',(34,'6666666'))] AS telefono ARRAY),CAST (('Aleluya',20,('Montilla',('Cadiz','Andalucía'),'España'),14550) AS direccion))";
