...
public class PR015 {
	...
	public static void main(String[] args) {
		...
		Query cons = session.createQuery(
				"SELECT h.curso.id.codOe, h.curso.id.codCurso, h.curso.ofertaeducativa.nombre "
				+ "FROM Horario h "
				+ "Group by 1,2 "
				+ "HAVING avg(h.asignatura.horasTotales)<"
				+ "(SELECT avg(r.asignatura.horasTotales) FROM Reparto r "
				+ "WHERE r.profesor.codProf = :cod)");
