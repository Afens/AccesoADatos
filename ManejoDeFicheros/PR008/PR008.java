            ...
            while (true) {
                try {
                    System.out.printf("Nombre: %s\n\tTelefono: %s\n\tDireccion: %s\n\tCodigo Postal: %d\n\t%s\n\n",
                            leer.readUTF(), leer.readUTF(), leer.readUTF(), leer.readInt(), leer.readBoolean() ? String.format("Le debo %.2f $", leer.readFloat()) : String.format("No le debo", leer.readFloat()));
